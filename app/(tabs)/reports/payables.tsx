...
const createStyles = (colors: any) => StyleSheet.create({
    ...
    card: { backgroundColor: colors.card + 'E0', borderRadius: 14, padding: 16, marginBottom: 12, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.06, shadowRadius: 4, elevation: 2, borderLeftWidth: 4, borderLeftColor: colors.danger, borderWidth: 1, borderColor: colors.border },
